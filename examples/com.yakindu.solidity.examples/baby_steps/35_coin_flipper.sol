...
contract CoinFlipper {
    ...
    function getEndowmentBalance() view public returns (uint) {
    ...
    function sha(uint128 wager) view private returns(uint256) // DISCLAIMER: This is pretty random... but not truly random.
    {
    ...
    function betAndFlip() payable public {
        ...
        uint128 lastblockhashused_uint = wager;
        ...
        if (hashymchasherton % 2 == 0) {
            ...
            lastgainloss = wager;
            lastresult = "win";
            msg.sender.transfer(wager * 2); // They won. Return bet and winnings.
        }
    }

    function getLastBlockNumberUsed() view public returns (uint) {
        return lastblocknumberused;
    }

    function getLastBlockHashUsed() view public returns (bytes32) {
        return lastblockhashused;
    }

    function getResultOfLastFlip() view public returns (string memory) {
        return lastresult;
    }

    function getPlayerGainLossOnLastFlip() view public returns (int) {
        return lastgainloss;
    }
