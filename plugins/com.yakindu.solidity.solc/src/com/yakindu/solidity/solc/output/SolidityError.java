...
public enum SolidityError {
	...
	ERROR_FUNCTION_DECLARED_AS_PURE_BUT_MUST_BE_VIEW(
	...
	ERROR_DATA_LOCATION_MUST_BE_SPECIFIED_FOR_VARIABLE(
			"Data location must be \"storage\" or \"memory\" for variable, but none was given."),
	...
	ERROR_DATA_LOCATION_MUST_BE_MEMORY_OR_CALLDATA(
	...
	ERROR_DATA_LOCATION_MUST_BE_MEMORY_OR_STORAGE_FOR_RETURN_PARAMETER(
			"Data location must be \"storage\" or \"memory\" for return parameter in function, but none was given."),
	ERROR_MEMBER_TRANSFER_NOT_FOUND_OR_VISIBLE(
			"Member \"transfer\" not found or not visible after argument-dependent lookup in address."),
	ERROR_MEMBER_BALANCE_NOT_FOUND_OR_VISIBLE(
			"Member \"balance\" not found or not visible after argument-dependent lookup in contract"),
	ERROR_USE_FALLBACK_OR_RECEIVE("Expected a state variable declaration. If you intended this as a fallback function or a function to handle plain ether transactions, use the \"fallback\" keyword or the \"receive\" keyword instead."),
	...
	ERROR_ADD_EMIT("Event invocations have to be prefixed by \"emit\"."),
	...
	ERROR_DIFFERENT_COMPILER_REQUIRED("Source file requires different compiler version"),
